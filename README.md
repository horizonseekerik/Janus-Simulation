...
[![Repository](https://img.shields.io/badge/Repository-Janus--Simulation-blue.svg)](https://github.com/horizonseekerik/Janus-Simulation)
...
[![Simulation Matrix](https://img.shields.io/badge/Simulation%20Targets-16%2F16%20Met%20(100%25)-brightgreen.svg)](#-16-point-quantitative-verification-sign-off-matrix)
...
This repository is the dedicated, standalone **Multi-Physics Co-Simulation and Verification Framework** for **Project JANUS**: a constraint-aware, bounded-exact optoelectronic tensor computing architecture engineered for high-throughput, ultra-low-power deep learning acceleration.

> [!NOTE]
> This repository contains the complete 5-tier co-simulation engine, testbenches, physical GDS II mask synthesizers, and Cloud HPC verification suites. For the companion full-stack repository (including the Vercel web application, interactive 3D dashboard, serverless APIs, and IEEE/Optica publication manuscripts), please visit [janus-photonic-hardware](https://github.com/horizonseekerik/janus-photonic-hardware).

### Verified Architectural Metrics (Cloud HPC Production Validated)
...
* **1,000,000-Run Production Cloud HPC Sign-Off**:
  * **1M-Sample Monte Carlo Tolerance**: $100.0000\%$ optical link yield, $+7.10\text{ dB}$ mean link margin, $+6.95\text{ dB}$ at $3\sigma$ worst-case process corner ($+6.85\text{ dB}$ at $5\sigma$).
  ...
  * **16/16 Multi-Physics Checks Met (100%)** with zero physics bypasses.
...
* **INT4 Peak Throughput**: **3,276.8 TOPS** ($978.1\text{ TOPS/W}$)
* **INT64 Deterministic Exact Precision**: **204.8 TOPS** ($61.1\text{ TOPS/W}$)
...
```bash
# Clone the standalone simulation repository
...
```
Janus-Simulation/
├── README.md                              # Standalone Simulation Framework & Verification Guide
├── requirements.txt                       # Python dependencies for the simulation framework
├── LICENSE.md                             # Repository License (Apache 2.0)
│
└── janus_mini16_sim/                      # Core 5-Tier Co-Simulation Suite
    ...
    ├── requirements.txt                   # Simulation-specific Python dependencies
    ├── README.md                          # In-depth architectural & simulation guide
    │
...
```bibtex
@article{janus2026simulation,
  title   = {Project JANUS: Multi-Physics Co-Simulation & Verification Framework for Spatial Optical RNS Photonic AI Accelerators},
