...
+---+---------------------------------+--------------------------+----------------------------+---------------------+
| 24| Transistor Random Dopant        | 65nm Planar StrongARM    | Channel dopant count       | Input-referred DC   |
...
* **Physical Phenomenon:** Dopant atom count statistics in 65nm planar MOSFETs create an input-referred DC offset that can flip weak decisions.
